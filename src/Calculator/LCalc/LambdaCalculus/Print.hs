...
-- | Pretty-printer for LCalc.

module LCalc.LambdaCalculus.Print where
...
instance Print LCalc.LambdaCalculus.Abs.Ident where
  prt _ (LCalc.LambdaCalculus.Abs.Ident i) = doc $ showString i
instance Print LCalc.LambdaCalculus.Abs.Program where
  prt i = \case
    LCalc.LambdaCalculus.Abs.AProgram terms -> prPrec i 0 (concatD [prt 0 terms])

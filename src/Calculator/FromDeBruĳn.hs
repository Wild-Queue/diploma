...
fromDeBruĳnTerm x nameDict = case x of
  ...
  DBCalculus.Binder variable term -> do 
    case variable of 
      DBCalculus.Identifier (DBCalculus.Ident varName) -> do
        ...
        let indexedTerm = fromDeBruĳnTerm term dictWithVar 
        LCalculus.Binder (LCalculus.Identifier (LCalculus.Ident (intToString dictLength))) indexedTerm
